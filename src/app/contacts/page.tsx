  ...
  return (
    <div className='contacts'>
      ...
      <div className='contacts__details'>
        <p><strong>Store Name:</strong> Bride's Charm</p>
        <p><strong>Address:</strong> 123 Wedding Lane, Bridal City, BC 12345</p>
        <p><strong>Phone:</strong> (123) 456-7890</p>
        <p><strong>Email:</strong> bridescharm@gmail.com</p>
      </div>
